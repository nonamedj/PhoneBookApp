...
public class ViewController implements Initializable {
    ...
    //<editor-fold defaultstate="collapsed" desc="FXML_DECLARATION">
    @FXML
            TableView table;
    @FXML
...
//</editor-fold>
   ...
   private void addContact(ActionEvent event){
       ...
       if(email.length() > 3 && email.contains("@") && email.contains(".")){
          Person newPerson = new Person(inputLastname.getText(), inputFirstname.getText(), email);
           ...
           alert("Adj meg egy valid emailcímet!");
       }
   ...
   private void exportList(ActionEvent event){
       ...
       //kivesszük a whitespace karaktereket
   ...
   public void setTableData(){
        ...
        TableColumn emailCol = new TableColumn("Emailcím");
   ...
   private void setMenuData() {
        ...
        //nodeItemA.setExpanded(true);  egyből látszik a lista lenyitva
        ...
        treeView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
          public void changed(ObservableValue observable, Object oldValue, Object newValue){
              ...
              //System.out.println("A választott menü: " + selectedMenu); eredmény csekk kattintásra
   ...
   private void alert(String text){
       ...
       anchor.setTopAnchor(vbox, 300.);
       anchor.setLeftAnchor(vbox, 270.0);
